...
{
    private const string ClientId = "668537866762-p02cs7ksu6rg0n1rgjogfmeeajv1hjnd.apps.googleusercontent.com"; //TODO: Change [CLIENT_ID] to your CLIENT_ID
    private const string ClientSecret = "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"; //TODO: Change [CLIENT_SECRET] to your CLIENT_SECRET
    ...
    {
        Application.OpenURL($"https://accounts.google.com/o/oauth2/v2/auth?client_id={ClientId}&redirect_uri=urn:ietf:wg:oauth:2.0:oob&response_type=code&scope=profile");
    }
